...
def get_X_y_sub(
    working_dir=os.path.join(os.getcwd(),'temp'), # this directory will be created inside colab
    ...
    zip_dir = os.path.join("src", 
                            "load_data_time_series", 
                            "HAR", 
                            "e4_wristband_Nov2019",
                            "zip_datafiles",
                            "sub1"),
    zip_flist = [],
    ...
    for i in zip_flist:
        ...
        ffname = os.path.join(working_dir, 'ACC.csv')
        ...
        tag_ffname = os.path.join(working_dir, 'tags.csv')
