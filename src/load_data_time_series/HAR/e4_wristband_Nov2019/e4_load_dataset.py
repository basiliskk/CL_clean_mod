...
my_path = os.path.join("load_data_time_series")
working_path = os.path.join(os.getcwd(), my_path)

# use get_x_y_sub to get partially processed numpy arrays
full_filename = os.path.normpath(os.path.join(working_path,"HAR","e4_wristband_Nov2019","e4_get_x_y_sub.py"))
